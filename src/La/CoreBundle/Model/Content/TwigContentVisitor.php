...
class TwigContentVisitor implements VisitorInterface, HtmlContentVisitorInterface, UrlContentVisitorInterface, QuestionContentVisitorInterface, QuizContentVisitorInterface
{
    /**
     * {@inheritdocm
     */
    ...
    {
        $form = 'LaLearnodexBundle:Admin:questionContent.html.twig';
        return $form;
    }
