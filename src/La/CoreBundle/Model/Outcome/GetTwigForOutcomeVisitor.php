...
class GetTwigForOutcomeVisitor implements VisitorInterface, AffinityOutcomeVisitorInterface, AnswerOutcomeVisitorInterface
{
    /**
     * {@inheritdocm
     */
    ...
    {
        return 'LaLearnodexBundle:Admin:Outcome/AnswerOutcome.html.twig';
    }
